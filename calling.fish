...
sub -n calling -w "nextflow -config calling.config run -resume -work-dir $workdir calling.nf "\
  "--outdir $outdir --reference $reference --scaffold $scaffolds --bamfiles $bamfiles"